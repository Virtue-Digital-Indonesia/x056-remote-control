...
(async()=>{
 ...
 try{
  ...
  await page.reload();await page.locator('#rcProjectContext [data-tools]').waitFor();assert.equal(await page.locator('#prompt').inputValue(),'Unsent Work integration draft');
